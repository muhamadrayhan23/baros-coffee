...
@section('content')
    <div class="bg-white border border-coffee-bean/10 rounded-2xl p-6 md:p-8 shadow-sm space-y-6">
        <div class="flex items-center space-x-3 border-b border-coffee-bean/10 pb-5">
            ...
            <div>
                <h2 class="text-xl font-extrabold tracking-tight text-coffee-bean">Ubah Banner</h2>
                <p class="text-xs opacity-65">Perbarui judul, gambar, dan status banner.</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input id="nama_banner" type="text" name="nama_banner"
                    value="{{ old('nama_banner', $banner->nama_banner) }}" required
            ...
            <div>
                <label for="gambar" class="block text-sm font-semibold mb-2 text-coffee-bean">Gambar Banner Baru</label>
            ...
            <div class="flex items-center gap-3">
                ...
                <label for="published" class="text-sm text-coffee-bean font-semibold">Banner dipublikasikan</label>
            </div>
